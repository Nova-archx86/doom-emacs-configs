...
* Installation
Installing my configuration is failry easy and just requires a git clone into ~/.config/doom
#+begin_src shell
git clone https://github.com/Nova-archx86/doom-emacs-configs ~/.config/doom && ~/.config/emacs/bin/doom sync
#+end_src

* Variables

** Font, Doom theme, and Splash 
#+begin_src emacs-lisp :tangle config.el
(setq fancy-splash-image (expand-file-name "doom-splash.svg" doom-user-dir))
